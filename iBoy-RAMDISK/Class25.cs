...
{
	// Token: 0x0600011E RID: 286 RVA: 0x00011CAC File Offset: 0x0000FEAC
	public bool method_0(string string_0, string string_1)
	{
		...
		if (num <= 2065103420U)
		{
			if (num != 850372319U)
			{
				...
				else if (num == 2065103420U)
				{
					if (string_0 == "boot_purple")
					{
						return this.method_1(string_1);
					}
				}
		...
		else if (num > 3499401685U)
		{
			...
			else if (string_0 == "gaster")
			{
				return this.method_1(string_1);
			}
		}
		else if (num == 2192567781U)
		{
			if (string_0 == "eraser")
			{
				return this.method_1(string_1);
	...
	// Token: 0x0600011F RID: 287 RVA: 0x00011DCC File Offset: 0x0000FFCC
	...
	// Token: 0x06000120 RID: 288 RVA: 0x00011E78 File Offset: 0x00010078
	...
	// Token: 0x06000121 RID: 289 RVA: 0x00011F04 File Offset: 0x00010104
