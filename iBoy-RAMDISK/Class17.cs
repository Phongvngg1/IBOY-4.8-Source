...
{
	// Token: 0x060000E7 RID: 231 RVA: 0x0000DDB8 File Offset: 0x0000BFB8
	public void method_0()
	{
		string string_ = Class19.model;
		string text = string_;
		...
		if (num > 1134978372U)
		{
				...
				if (num <= 3579376904U)
				{
					if (num == 3266955512U)
					{
						if (text == "iPad7,11")
						{
							this.method_15();
							this.method_13(1);
							this.method_12(Class19.model + "-" + Class19.string_0 + ".zip");
							this.method_13(1);
							this.method_1();
							return;
						}
					...
					else if (num != 3317288369U)
					{
						if (num == 3579376904U)
						{
							if (text == "iPhone8,4")
							{
								MessageBox.Show("Device Type : " + Class19.model + " Not Supported Without DCSD!", "iBoy Ramdisk", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
								return;
							}
						}
					}
			...
			else if (num != 2253431467U)
			{
				...
				else if (num == 2286986705U && text == "iPhone10,4")
				{
					this.method_15();
					this.method_12(Class19.model + "-" + Class19.string_0 + ".zip");
					this.method_13(1);
		...
		MessageBox.Show("Device Type : " + Class19.model + " Not Supported!\n Please Use Magiccfg !!", "iBoy Ramdisk", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
	}

	// Token: 0x060000E8 RID: 232 RVA: 0x0000E624 File Offset: 0x0000C824
	...
	// Token: 0x060000E9 RID: 233 RVA: 0x0000E70C File Offset: 0x0000C90C
	...
	// Token: 0x060000EA RID: 234 RVA: 0x0000E800 File Offset: 0x0000CA00
	public void method_3()
	{
		...
		if (num <= 1101423134U)
		{
			if (num <= 291253989U)
			{
				if (num > 218008307U)
				{
					if (num > 251563545U)
					{
						if (num != 268341164U)
						{
							if (num == 291253989U && text == "iPad6,11")
							{
								this.method_4();
								return;
							}
					...
					{
						if (num == 251563545U && text == "iPad7,1")
						{
							this.method_4();
							return;
						}
					}
					else if (text == "iPad6,12")
					{
						this.method_4();
						return;
					}
				...
				else if (num > 80824001U)
				{
					if (num != 201230688U)
					{
						if (num == 218008307U && text == "iPad7,3")
						{
							this.method_4();
							return;
						}
					}
					else if (text == "iPad7,2")
					{
						this.method_4();
						return;
					}
			...
			else if (num != 977265701U)
			{
				if (num != 1084645515U)
				{
					if (num == 1101423134U && text == "iPad5,2")
					{
						this.method_4();
						return;
					}
				}
				else if (text == "iPad5,1")
				{
					this.method_4();
					return;
				}
		...
		else if (num > 2303764324U)
		{
			if (num > 3317288369U)
			{
				if (num <= 3663264999U)
				{
					...
					else if (num == 3663264999U && text == "iPhone8,1")
					{
						this.method_4();
						return;
					}
			...
			else if (num > 2337319562U)
			{
				if (num != 3266955512U)
				{
					if (num == 3317288369U && text == "iPad7,12")
					{
						this.method_4();
						return;
					}
		...
		MessageBox.Show("Device Type : " + Class19.model + " Not Supported!", "iBoy Ramdisk", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
	}

	// Token: 0x060000EB RID: 235 RVA: 0x0000ED90 File Offset: 0x0000CF90
	public void method_4()
	{
		...
		})))
		{
			...
			this.method_9(Class19.model + "-" + Class19.string_0 + ".zip");
			this.method_13(1);
			this.method_8();
		}
		else
	...
	// Token: 0x060000EC RID: 236 RVA: 0x0000EE80 File Offset: 0x0000D080
	public void method_5()
	{
		...
		if (num > 318674021U)
		{
			if (num <= 2320541943U)
			{
				...
				else if (num == 2270209086U && text == "iPhone10,5")
				{
					this.method_6();
					return;
				}
			...
			else if (num == 3266955512U && text == "iPad7,11")
			{
				this.method_6();
				return;
			}
		...
		else if (num <= 240921132U)
		{
			if (num <= 80824001U)
			{
				...
				else if (num == 80824001U && text == "iPad6,8")
				{
					this.method_6();
					return;
				}
		...
		else if (num == 268341164U && text == "iPad7,6")
		{
			this.method_6();
			return;
		}
	...
	// Token: 0x060000ED RID: 237 RVA: 0x0000F1AC File Offset: 0x0000D3AC
	public void method_6()
	{
		...
		{
			Console.WriteLine("Ada File");
			this.method_9(Class19.model + "-" + Class19.string_0 + "-16.x.zip");
			this.method_13(1);
			this.method_7();
		}
		this.method_15();
	...
	// Token: 0x060000EE RID: 238 RVA: 0x0000F28C File Offset: 0x0000D48C
	...
	// Token: 0x060000EF RID: 239 RVA: 0x0000F614 File Offset: 0x0000D814
	...
	// Token: 0x060000F0 RID: 240 RVA: 0x0000F89C File Offset: 0x0000DA9C
	...
	// Token: 0x060000F1 RID: 241 RVA: 0x0000F988 File Offset: 0x0000DB88
	...
	// Token: 0x060000F2 RID: 242 RVA: 0x0000FB28 File Offset: 0x0000DD28
	...
	// Token: 0x060000F3 RID: 243 RVA: 0x0000FCC8 File Offset: 0x0000DEC8
	public void method_12(string string_4)
	{
		this.method_17(Class17.string_3, string_4);
		try
		{
			...
			using (ZipFile zipFile = ZipFile.Read(Class17.string_0 + "/Data/" + string_4))
			{
				zipFile.Password = "iBoyRamdisk123!@#";
				foreach (ZipEntry zipEntry in zipFile)
				{
			...
			File.Delete(Class17.string_0 + "\\Data\\" + string_4);
	...
	// Token: 0x060000F4 RID: 244 RVA: 0x0000819C File Offset: 0x0000639C
	...
	// Token: 0x060000F5 RID: 245 RVA: 0x0000827C File Offset: 0x0000647C
	...
	// Token: 0x060000F6 RID: 246 RVA: 0x0000FDDC File Offset: 0x0000DFDC
	...
	// Token: 0x060000F7 RID: 247 RVA: 0x0000FE54 File Offset: 0x0000E054
	...
	// Token: 0x060000F8 RID: 248 RVA: 0x0000FEA4 File Offset: 0x0000E0A4
	...
	// Token: 0x060000F9 RID: 249 RVA: 0x0000FEF4 File Offset: 0x0000E0F4
	public void method_17(string string_4, string string_5)
	{
		try
		{
			...
			webClient.DownloadFileAsync(new Uri(string_4), Class17.string_0 + "/Data/" + string_5);
		}
		catch (Exception ex)
		{
	...
	// Token: 0x060000FA RID: 250 RVA: 0x0000FF7C File Offset: 0x0000E17C
	...
	{
		"https://mahapala.unnes.ac.id/purple_ios/",
		Class19.model,
		"-",
		Class19.string_0,
		".zip"
	...
	{
		// Token: 0x060000FE RID: 254 RVA: 0x000100B0 File Offset: 0x0000E2B0
