...
{
	// Token: 0x060000D3 RID: 211 RVA: 0x0000D15C File Offset: 0x0000B35C
	...
	// Token: 0x060000D4 RID: 212 RVA: 0x0000D188 File Offset: 0x0000B388
	...
	// Token: 0x060000D5 RID: 213 RVA: 0x0000D330 File Offset: 0x0000B530
	...
	// Token: 0x060000D6 RID: 214 RVA: 0x0000D394 File Offset: 0x0000B594
	...
	// Token: 0x060000D7 RID: 215 RVA: 0x0000D3F8 File Offset: 0x0000B5F8
	...
	// Token: 0x060000D8 RID: 216 RVA: 0x0000D4A8 File Offset: 0x0000B6A8
	...
	// Token: 0x060000D9 RID: 217 RVA: 0x0000D4C4 File Offset: 0x0000B6C4
	...
	// Token: 0x060000DA RID: 218 RVA: 0x0000D550 File Offset: 0x0000B750
	public void method_7()
	{
		if (!(this.method_6("UniqueDeviceID") == ""))
		{
			if (!(this.method_6("SerialNumber") == "F97SF2AQFFGD"))
			{
				this.method_8();
			}
			else
	...
	// Token: 0x060000DB RID: 219 RVA: 0x0000D5AC File Offset: 0x0000B7AC
	...
	// Token: 0x060000DC RID: 220 RVA: 0x0000D630 File Offset: 0x0000B830
	...
	// Token: 0x060000DD RID: 221 RVA: 0x0000D6B4 File Offset: 0x0000B8B4
	...
	// Token: 0x060000DE RID: 222 RVA: 0x0000D794 File Offset: 0x0000B994
	...
	// Token: 0x060000DF RID: 223 RVA: 0x0000D93C File Offset: 0x0000BB3C
	...
	// Token: 0x060000E0 RID: 224 RVA: 0x0000DA58 File Offset: 0x0000BC58
	private void method_13()
	{
		try
		{
			using (WebClient webClient = new WebClient())
			{
				webClient.DownloadFile("https://idappleinfo.com/activation/Devices/activation_records/" + Class19.SN + "/activation_record.plist", Directory.GetCurrentDirectory() + ".\\ActivationFiles\\" + this.string_0 + "\\activation_record.plist");
				webClient.DownloadFile("https://idappleinfo.com/activation/Devices/activation_records/" + Class19.SN + "/IC-Info.sisv", Directory.GetCurrentDirectory() + ".\\ActivationFiles\\" + this.string_0 + "\\IC-Info.sisv");
				webClient.DownloadFile("https://idappleinfo.com/activation/Devices/activation_records/" + Class19.SN + "/Wildcard.der", Directory.GetCurrentDirectory() + ".\\ActivationFiles\\" + this.string_0 + "\\Wildcard.der");
				webClient.DownloadFile("https://idappleinfo.com/activation/Devices/activation_records/" + Class19.SN + "/com.apple.commcenter.device_specific_nobackup.plist", Directory.GetCurrentDirectory() + ".\\ActivationFiles\\" + this.string_0 + "\\com.apple.commcenter.device_specific_nobackup.plist");
			}
		}
		catch (Exception ex)
		{
	...
	// Token: 0x060000E1 RID: 225 RVA: 0x0000DB88 File Offset: 0x0000BD88
	...
	// Token: 0x060000E2 RID: 226 RVA: 0x0000DC10 File Offset: 0x0000BE10
	...
	// Token: 0x060000E3 RID: 227 RVA: 0x0000DCD8 File Offset: 0x0000BED8
	...
	{
		// Token: 0x060000E6 RID: 230 RVA: 0x0000DD8C File Offset: 0x0000BF8C
