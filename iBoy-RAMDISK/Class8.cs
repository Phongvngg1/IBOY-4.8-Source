...
{
	// Token: 0x06000066 RID: 102 RVA: 0x00007A88 File Offset: 0x00005C88
	public void method_0()
	{
		...
		this.method_4(Class19.model + "-" + Class19.string_0 + ".zip");
		this.method_3(1);
		this.method_2();
		this.method_6();
	}

	// Token: 0x06000067 RID: 103 RVA: 0x00007B70 File Offset: 0x00005D70
	public void method_1()
	{
		...
		if (num <= 977265701U)
		{
			...
			else if (num <= 876599987U)
			{
				...
				{
					if (num == 301896402U && text == "iPad7,4")
					{
						this.method_0();
						return;
					}
			...
			else if (num > 926932844U)
			{
				...
				else if (num == 977265701U && text == "iPhone9,2")
				{
					this.method_0();
					return;
				}
			...
			{
				if (num == 926932844U && text == "iPhone9,1")
				{
					this.method_0();
					return;
				}
		...
		else if (num > 2320541943U)
		{
			...
			else if (num <= 3680042618U)
			{
				...
				else if (num == 3680042618U && text == "iPhone8,2")
				{
					this.method_0();
					return;
				}
		...
		else if (num > 1134978372U)
		{
			...
			else if (num == 2320541943U && text == "iPhone10,2")
			{
				this.method_0();
				return;
			}
		...
		MessageBox.Show("Sorry " + Class19.model + " Not Supported For Now", "iBoy Ramdisk", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
	}

	// Token: 0x06000068 RID: 104 RVA: 0x00008088 File Offset: 0x00006288
	...
	// Token: 0x06000069 RID: 105 RVA: 0x0000819C File Offset: 0x0000639C
	...
	// Token: 0x0600006A RID: 106 RVA: 0x000081B8 File Offset: 0x000063B8
	...
	// Token: 0x0600006B RID: 107 RVA: 0x0000827C File Offset: 0x0000647C
	...
	// Token: 0x0600006C RID: 108 RVA: 0x000082DC File Offset: 0x000064DC
	...
	// Token: 0x0600006D RID: 109 RVA: 0x00008354 File Offset: 0x00006554
	...
	{
		// Token: 0x06000071 RID: 113 RVA: 0x00008408 File Offset: 0x00006608
